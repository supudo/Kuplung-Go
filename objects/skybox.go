...
func (sb *SkyBox) InitBuffers() {
	...
	vertexShader := engine.GetShaderSource(sett.App.AppFolder + "shaders/skybox.vert")
	fragmentShader := engine.GetShaderSource(sett.App.AppFolder + "shaders/skybox.frag")
